...
// endpoint setup
  ...
  app.get('/prices', (req, res) => {
    ...
    getStockPrices(stockSymbol, rapidApiKey, res) // **live only** - using static instance of API call to avoid over usage
  ...
  app.get('/tweets', (req, res) => {
    ...
    // deconstruct query params from request
    const {stockSymbol} = req.query;
    getTwitterData(stockSymbol, twitterKey, res) // **live only** - using static instance of API call to avoid over usage

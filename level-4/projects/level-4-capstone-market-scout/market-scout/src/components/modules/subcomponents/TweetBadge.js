...
export default function TweetBadge(props) {
    const {text, created_at, name, profile_image_url, username, verified} = props.tweetData;
    ...
    return (
        <div className={"tweet-badge-container"}>
            <div>
                <img src={profile_image_url} className={"tweet-badge-profile-picture"} alt="decorative profile illustration of given user."></img>
            </div>
